...
# ---------- 頁面設定 ----------
st.set_page_config(page_title="中華基督教會基慈小學 — 校務會議紀錄查詢 Powered by Qwen AI", page_icon="📋", layout="wide")
...
with st.sidebar:
    ...
    st.caption("校務會議紀錄查詢 Powered by Qwen AI")
...
# ==========================================
st.title("📋 中華基督教會基慈小學")
st.subheader("校務會議紀錄查詢 Powered by Qwen AI")
